...
class PlayDatePage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            cityValue: "",
    ...
    render() {
        const dogToShow = adupDogData.filter((filtered) => {
            ...
            return filtered.hasHome == true && isCity && isAge && isGender ; 
        });
